...
SKILL_CLAZZ = "FoxESSCloudSkill"  # Make sure it matches __init__.py class name
VERSION = "0.0.1"
URL = "https://github.com/JoergZ2/ovos-skill-my-foxess-cloud"
AUTHOR = "JoergZ2"
EMAIL = ""
LICENSE = "Apache2.0"
DESCRIPTION = "Skill for using FoxESS cloud data"
